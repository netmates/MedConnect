...
public class CreateScheduleSlotValidatorTests
{
    ...
    private static CreateScheduleSlotDto ValidDto(
        DateTime? start = null,
        DateTime? end = null)
    {
    ...
    public void Validate_WithStartTimeInPast_Fails()
    {
        ...
        Assert.Contains(
            result.Errors,
            e => e.PropertyName == nameof(CreateScheduleSlotDto.StartTime)
    ...
    public void Validate_WithEndTimeNotAfterStart_Fails()
    {
        ...
        Assert.Contains(
            result.Errors,
            e => e.PropertyName == nameof(CreateScheduleSlotDto.EndTime)
